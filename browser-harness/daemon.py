"""CDP WS holder + TCP relay. One daemon per BU_NAME."""
...
PORT = 62000 + int(hashlib.md5(NAME.encode()).hexdigest()[:3], 16) % 1000
LOG = str(_TMPDIR / f"bu-{NAME}.log")
PID = str(_TMPDIR / f"bu-{NAME}.pid")
BUF = 500
PROFILES = [
